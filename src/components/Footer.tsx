...
const Footer: React.FC = () => {
  return (
    <footer id="footer" className="footer bg-dark text-white" style={{ paddingBottom: '10px' }}>
        ...
        <Row className="gy-4">
          ...
          <Col lg={4} md={6} className="footer-about">
            ...
            <div className="footer-contact pt-3">
              ...
              <p>
                <strong>Email:</strong> <span>support@chaturdhaprojectsandservices.com</span>
              </p>
            </div>
            <div className="social-links d-flex mt-4 gap-3">
              <a href="https://x.com/bhawancare"><i className="bi bi-twitter-x text-white"></i></a>
              <a href="https://www.facebook.com/profile.php?id=61566381572393&sk=about"><i className="bi bi-facebook text-white"></i></a>
              <a href="https://www.instagram.com/bhawancare/"><i className="bi bi-instagram text-white"></i></a>
              <a href="https://www.linkedin.com/company/104807752/admin/page-posts/published/"><i className="bi bi-linkedin text-white"></i></a>
            </div>
          </Col>
