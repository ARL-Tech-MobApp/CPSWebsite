            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                {viewType === "employee" ? (
                  ...
                  <ul>
                    <li>
                      <strong>Employee ID:</strong> {visitorFormData.employeeId}
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      {visitorFormData.constructionMaterials?.join(", ")}
                    </li>
                    <li>
                      <strong>Description:</strong>{" "}
                      {visitorFormData.description}
                    </li>
                    <li>
                      <strong>Contact 1:</strong> {visitorFormData.contact1}
                    </li>
                    <li>
                      <strong>Contact 2:</strong> {visitorFormData.contact2}
                    </li>
                    <li>
                      <strong>Pincode:</strong> {visitorFormData.pincode}
                    </li>
                    <li>
                      <strong>Address:</strong> {visitorFormData.address}
                    </li>
                    <li>
                      <strong>Shop Status:</strong> {visitorFormData.shopStatus}
                    </li>
                    <li>
                      <strong>Has Visiting Card:</strong>{" "}
                      {visitorFormData.hasVisitingCard ? "Yes" : "No"}
                    </li>
                  </ul>
                )}
              </div>
